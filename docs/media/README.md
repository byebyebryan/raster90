...
This directory contains the small, tracked publication subset used by the
repository README. These files make the product visible on GitHub; they are not
the canonical validation archive.
